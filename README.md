...
`React` `TypeScript` `Node` `Python` `PostgreSQL` `Docker` `AI/AX Engineering` `AI Evaluation`

Currently deep in AI-assisted engineering workflows, LLM benchmark design, and secure enterprise tooling
(compliance, identity, and infrastructure-heavy systems for regulated industries).

---

## Selected Builds

A working set of self-directed builds — mostly rapid prototypes — used to explore architecture patterns,
UI systems, and AI-assisted workflows end to end.
...
- [React Design System Walkthrough](https://loom.com/share/aef4cc32b58a499eb1b5b912a6f467d3)
- [Architecture / DX Deep Dive](https://www.loom.com/share/407edbbe40e2462a87987a362c15b413)
- [AI-Assisted Build Walkthrough](https://www.loom.com/share/b50210e2b7af49bb8c53563487a8a2e8)

---

## Background

Principal-level engineer specializing in React architecture, design systems, developer experience (DX),
and AI-assisted engineering (AX). Past work spans national labs (LANL, SNL, SRNS), federal contractors (NNSA),
and consumer platforms (Disney+, Hulu, Medable). Currently building AI evaluation infrastructure for
